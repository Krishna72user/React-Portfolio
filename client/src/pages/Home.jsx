    ...
    <div className='flex  gap-5 pb-8 flex-wrap justify-around w-full '>
      <div className="w-[30em] lg:w-[35em]  flex pl-9 pb-6 pt-4 flex-col gap-3">
        ...
        <div className='lg:text-3xl w-auto md:text-2xl  text-2xl'>I'm Krishna Laha</div>
          ...
          A passionate Full-Stack Developer and aspiring Data Scientist, dedicated to crafting elegant, scalable, and efficient web applications with seamless user experiences. I love turning ideas into impactful digital solutions that blend creativity with performance. Let's connect and bring your vision to life!
          </div>
